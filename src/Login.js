...
export default Login  = function({navigation}){
  return (
    ...
    <SafeAreaView style={styles.container}>
      <TouchableOpacity onPress ={()=>navigation.navigate('Welcome')} style={{alignSelf:'left', marginLeft:23}}><Icon name="arrow-left" size={30}  /></TouchableOpacity>
      <View style={styles.avatarContainer}>
        
      <LottieView source={require('./../assets/login.json')} autoPlay loop speed={1}  style={styles.logo} />
      </View>
      <Text style={{fontWeight:'bold', color:'#fff',fontSize:30, marginTop:5,}}>Log in </Text>
