  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.box}>
        ...
        {temparature > 33 ? (
          <Text>It's quite hot today</Text>
        ) : temparature < 20 ? (
          <Text>It's quite cold today</Text>
        ) : null}
        {temparature > 20 && temparature < 33 && humid > 40 && humid < 70 ? (
          <Text>It's great for a football game</Text>
        ) : null}
      ...
      <View style={styles.box1}>
        <View style={styles.humid}>
          <Image
            source={require("../../img/humid.png")}
            style={styles.humid_img}
          />
          <Text style={styles.humid_value}>
            {humid ? (
              <Text>{humid}</Text>
            ) : (
              <Text style={styles.script}>Loading...</Text>
